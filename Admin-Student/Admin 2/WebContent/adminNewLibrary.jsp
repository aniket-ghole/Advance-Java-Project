...
<h1 style="font-family:serif; font-size: 40px; font-weight: bold; margin-left: 460px;">Add a New Book to Library</h1>
<form action=AdminNewLibraryServlet method=post>
<label>
...
<br><br></label>
<button style="margin-left:550px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Add New Book</button>
</form>
<br>
<br>
