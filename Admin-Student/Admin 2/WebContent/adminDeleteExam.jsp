...
<br><br></label>
<button style="margin-left:580px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Delete Exam</button>
</form>
<br>
<br>
