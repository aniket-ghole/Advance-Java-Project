...
<h1 style="font-family:serif; font-size: 40px; font-weight: bold; margin-left: 460px;">Delete a Book from Library</h1>
...
<br><br></label>
<button style="margin-left:550px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Delete Book</button>
</form>
<br>
<br>
