...
<br><br>
<a href=adminNewLibrary.jsp><button style="margin-left: 290px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Add a New Book To Library</button></a>
<a href=adminUpdateLibrary.jsp><button style="margin-left: 150px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Update a Book from Library</button></a><br><br> 
<a href=adminDeleteLibrary.jsp><button style="margin-left: 525px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Delete a Book from Library	</button></a>
<br><br>
