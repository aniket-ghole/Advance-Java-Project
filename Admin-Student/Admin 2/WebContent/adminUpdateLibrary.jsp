...
<h1 style="font-family:serif; font-size: 40px; font-weight: bold; margin-left: 460px;">Update a Book from Library</h1>
<form action=AdminUpdateLibraryServlet method=post>
<label>
<span style="margin-left: 350px;">Book ID : </span><br>
<input style="margin-left: 350px;" required type="text" name="bookid">
<br><br></label>
<label>
<span style="margin-left: 350px;">Book Name : </span><br>
<input style="margin-left: 350px;" required type="text" name="bname">
<br><br></label>
<label>
<span style="margin-left: 350px;">Author's Name : </span><br>
<input style="margin-left: 350px;" required type="text" name="aname">
<br><br></label>
<label>
<span style="margin-left: 350px;">Publisher's Name : </span><br>
<input style="margin-left: 350px;" required type="text" name="pname">
<br><br></label>
<button style="margin-left:550px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Update Book</button>
</form>
<br>
<br>
