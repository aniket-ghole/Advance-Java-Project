...
<button style="font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Sign Up as New User</button>
<button onclick="goBack()" style="margin-left:50px; padding:14px 40px; font-family:serif; font-size: 20px; border-color:black; border-radius: 12px; " type="button">Cancel</button>
</div>
</form>
<br>
<br>
