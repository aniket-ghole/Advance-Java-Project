...
<p style="padding-left:200px ; font-family:serif; font-size: 30px;"><b>Your Profile</b></p>
<%
...
try{
	...
	PreparedStatement preparedStatement = con.prepareStatement("select * from details where name='"+ck[0].getValue()+"'");
...
%>
<br>
<p style="padding-left:200px ; font-family:serif; font-size: 30px;"><b>Update Profile Details</b></p>
...
<br><br></label>
<button style="font-family:serif; font-size: 20px; border-color:black; border-radius: 5px;" type="submit">UPDATE PROFILE</button>
</form>
<br>
<br>
