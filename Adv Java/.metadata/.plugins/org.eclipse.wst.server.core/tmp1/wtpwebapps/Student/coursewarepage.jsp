...
try {
	...
	String nam=ck[0].getValue();
	System.out.println(nam);
	Class.forName("org.h2.Driver");

	Connection con = DriverManager.getConnection("jdbc:h2:tcp://localhost/~/AdvJava", "niit", "1234");

	PreparedStatement preparedStatement = con.prepareStatement("select * from courseware where standard  IN (select standard from student where name='"+nam+"')");
	out.println("<h2><center><b>Courseware</b></center></h2>");
	out.println("<table class='beta' align=center border=7 width=70% height=70%");
	out.print("<tr><th>SUBJECT CODE</th><th>SUBJECT NAME</th></tr>");
