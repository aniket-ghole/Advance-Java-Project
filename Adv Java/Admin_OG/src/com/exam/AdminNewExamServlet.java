...
public class AdminNewExamServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:h2:~/test", "tanay", "12345");
			...
			out.print("<b>NEW EXAM SUCCESSFULLY ADDED</b>");
			RequestDispatcher requestDispatcher = request.getRequestDispatcher("/adminexam.html");
