...
public class AdminDeleteStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement preparedStatement = con.prepareStatement("delete from student where name=? and standard=?");
			preparedStatement.setString(1, name);
			preparedStatement.setString(2, standard);
			
			preparedStatement.executeUpdate();
			
			out.print("<center><b>STUDENT SUCCESSFULLY DELETED</b></center>");
