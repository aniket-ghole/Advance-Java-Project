...
public class AdminUpdateStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement preparedStatement = con.prepareStatement("update student set password='"+password+"',address='"+address+"',phone='"+phone+"',email='"+email+"',standard='"+standard+"' where name='"+name+"'");
