...
<input type="submit" value="Go Back to Home Page" style="font-family:serif; margin-left:200px; font-size: 15px; font-weight:bold; color:black; border-color:black;  background: !important; padding-bottom:1px ">
</form>
<br><br>
<a href=adminNewCourseware.jsp><button style="margin-left: 250px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; ;" type="submit">Add a New Subject to Courseware</button></a>
<a href=adminUpdateCourseware.jsp><button style="margin-left: 120px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; " type="submit">Update a Subject from Courseware</button></a><br><br> 
<br><br><a href=adminDeleteCourseware.jsp><button style="margin-left: 490px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; " type="submit">Delete a Subject from Courseware</button></a>
