...
<h1 style="font-family:serif; font-size: 40px; font-weight: bold; margin-left: 550px;">Add a New Exam</h1>
<form action=AdminNewExamServlet method=post>
<label>
...
<br><br></label>
<button style="margin-left:540px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Add a New Exam</button>
</form>
<br>
<br>
