...
<br><br>
<a href=adminNewStudent.jsp><button style="margin-left: 200px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Add a New Student</button></a>
<a href=adminUpdateStudent.jsp><button style="margin-left: 120px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Update a Student</button></a> 
<a href=adminDeleteStudent.jsp><button style="margin-left: 120px; font-family:serif; padding:12px 38px; font-size: 20px; border-color:black; border-radius: 12px;" type="submit">Delete a Student</button></a>
