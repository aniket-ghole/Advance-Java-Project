...
<br><br>
<button onclick="goBack()" style="font-family:serif; margin-left:200px; font-size: 15px; font-weight:bold; color:black; border-color:black;  background: !important; padding-bottom:1px " type="submit">Go Back to Courseware Page</button>
<h1 style="font-family:serif; font-size: 40px; font-weight: bold; margin-left: 400px;">Delete a Subject from Courseware</h1>
<form action=AdminDeleteCoursewareServlet method=post>
<label>
<span style="margin-left: 350px;">Subject Code : </span><br>
<input required style="margin-left: 350px;" type="text" name="subcode">
<br><br></label>
<br>
<button style="margin-left:500px ;font-family:serif; padding:14px 40px; font-size: 20px; border-color:black; " type="submit">Delete Subject From Courseware</button>
